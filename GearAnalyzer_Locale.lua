...
-- Dodge
AddStatPattern("dodge",
    ITEM_MOD_DODGE_RATING_SHORT or "",
    "Dodge", "Esquiva", "Esquiver")

-- Parry
AddStatPattern("parry",
    ITEM_MOD_PARRY_RATING_SHORT or "",
    "Parry", "Parada", "Parade")

-- Block
AddStatPattern("block",
    ITEM_MOD_BLOCK_RATING_SHORT or "",
    "Block", "Bloqueo", "Blocage")

-- Defense
AddStatPattern("defense",
    ITEM_MOD_DEFENSE_SKILL_RATING_SHORT or "",
